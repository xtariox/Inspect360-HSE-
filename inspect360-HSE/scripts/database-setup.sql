...
-- ========================================
-- 4. INSERT PREBUILT TEMPLATES
-- ========================================

-- Insert prebuilt templates for common HSE inspections
  ...
  '[
    ...
    },
    {
      ...
      "fields": [
        ...
        {"id": "safety_equipment_condition", "label": "Safety Equipment Condition", "type": "select", "options": ["Excellent", "Good", "Fair", "Poor"], "required": true}
      ]
    },
    {
      "id": 3,
      ...
      "fields": [
        ...
        {"id": "ventilation_working", "label": "Ventilation System Working", "type": "boolean", "required": true},
        {"id": "noise_levels", "label": "Noise Levels Acceptable", "type": "boolean", "required": true},
        {"id": "temperature", "label": "Temperature (°C)", "type": "number", "required": false},
        {"id": "humidity", "label": "Humidity (%)", "type": "number", "required": false}
      ]
    },
    {
      "id": 4,
      ...
      "fields": [
        {"id": "compliance_rating", "label": "Overall Compliance Rating", "type": "select", "options": ["Excellent", "Good", "Satisfactory", "Needs Improvement", "Non-Compliant"], "required": true},
        {"id": "risk_level", "label": "Risk Level", "type": "select", "options": ["Low", "Medium", "High", "Critical"], "required": true},
        {"id": "action_required", "label": "Immediate Action Required", "type": "boolean", "required": true},
...
(
  ...
  'Focused inspection template for machinery and equipment safety verification',
  'equipment',
  ARRAY['equipment', 'machinery', 'safety'],
  '[
    {
      "id": 1,
      "title": "Basic Information",
      "fields": [
        {"id": "title", "label": "Inspection Title", "type": "text", "required": true},
        {"id": "equipment_name", "label": "Equipment/Machinery Name", "type": "text", "required": true},
    ...
    },
    {
      ...
      "fields": [
        {"id": "overall_condition", "label": "Overall Equipment Condition", "type": "select", "options": ["Excellent", "Good", "Needs Attention", "Unsafe"], "required": true},
        {"id": "guards_in_place", "label": "Safety Guards in Place", "type": "boolean", "required": true},
        {"id": "lockout_tagout", "label": "Lockout/Tagout Procedures Available", "type": "boolean", "required": true},
        {"id": "maintenance_current", "label": "Maintenance Up to Date", "type": "boolean", "required": true},
        {"id": "equipment_photo", "label": "Equipment Photo", "type": "image", "required": false}
      ]
    },
    {
      "id": 3,
      ...
      "fields": [
        {"id": "operational_safety", "label": "Safe for Operation", "type": "boolean", "required": true},
        {"id": "emergency_stops", "label": "Emergency Stops Functional", "type": "boolean", "required": true},
        {"id": "safety_documentation", "label": "Safety Documentation Available", "type": "boolean", "required": true},
        {"id": "risk_assessment", "label": "Risk Level", "type": "select", "options": ["Low", "Medium", "High", "Critical"], "required": true},
...
(
  'Workplace Housekeeping Inspection',
  'Template for assessing workplace cleanliness and organization standards',
  'housekeeping',
  ARRAY['housekeeping', 'cleanliness', 'organization'],
  '[
    {
      "id": 1,
      "title": "Basic Information",
      "fields": [
        {"id": "title", "label": "Inspection Title", "type": "text", "required": true},
        {"id": "area", "label": "Work Area", "type": "text", "required": true},
        {"id": "inspector", "label": "Inspector Name", "type": "text", "required": true},
        {"id": "date", "label": "Inspection Date", "type": "date", "required": true}
      ]
    },
    {
      ...
      "fields": [
        {"id": "area_clean", "label": "Work Area Clean", "type": "boolean", "required": true},
        {"id": "floors_clear", "label": "Floors Clear of Debris", "type": "boolean", "required": true},
        {"id": "spills_cleaned", "label": "No Spills or Leaks", "type": "boolean", "required": true},
        {"id": "waste_disposal", "label": "Waste Properly Disposed", "type": "boolean", "required": true},
        {"id": "area_photo", "label": "Area Photo", "type": "image", "required": false}
      ]
    },
    {
      "id": 3,
      "title": "Organization",
      "fields": [
        {"id": "tools_organized", "label": "Tools Properly Organized", "type": "boolean", "required": true},
        {"id": "materials_stored", "label": "Materials Properly Stored", "type": "boolean", "required": true},
        {"id": "walkways_clear", "label": "Walkways Clear", "type": "boolean", "required": true},
        {"id": "housekeeping_score", "label": "Housekeeping Score (1-10)", "type": "number", "required": true},
        {"id": "improvement_areas", "label": "Areas for Improvement", "type": "textarea", "required": false}
      ]
    }
  ]'::jsonb,
  'system',
