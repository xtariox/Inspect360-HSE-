            ...
            <>
              ...
              <YStack gap="$3">
                ...
                <XStack gap="$3" flexWrap="wrap">
                  ...
                  >
                    <YStack gap="$2" alignItems="center">
                      <Database size={32} color={theme.colors.info} />
                      <Text style={{ fontSize: 24, fontWeight: 'bold', color: theme.colors.text }}>
                  ...
                  >
                    <YStack gap="$2" alignItems="center">
                      <Users size={32} color={theme.colors.secondary} />
                      <Text style={{ fontSize: 24, fontWeight: 'bold', color: theme.colors.text }}>
                        {dashboardStats.activeInspectors}
                      </Text>
                      <Text style={{ fontSize: 14, color: theme.colors.textSecondary }}>
                        Active Inspectors
                      </Text>
              ...
              <YStack gap="$3">
                ...
                <XStack gap="$3" flexWrap="wrap">
                  <Button 
                    ...
                    minWidth="45%"
                    onPress={() => {
                      // Navigate to Templates tab to choose or create a template
                      ...
                      >
                        <XStack alignItems="center" justifyContent="space-between">
                          ...
                          <XStack gap="$2">
                            <View style={{
                              backgroundColor: 
                                inspection.priority === 'critical' ? theme.colors.error + '20' :
                                inspection.priority === 'high' ? theme.colors.warning + '20' :
                                inspection.priority === 'medium' ? theme.colors.info + '20' :
                              ...
                              <Text style={{ 
                                color: 
                                  inspection.priority === 'critical' ? theme.colors.error :
                                  inspection.priority === 'high' ? theme.colors.warning :
                                  inspection.priority === 'medium' ? theme.colors.info :
